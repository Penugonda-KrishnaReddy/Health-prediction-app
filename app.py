...
def upload_file():
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            indices = {0: 'PARASITIC Infected', 1: 'Uninfected(Normal)'}
...
def result():
    ...
    if(int(result)==1):
        prediction='Sorry ! Your are Suffering'
    else:
        prediction='Congrats ! you are Healthy' 
    
    return(render_template("result.html", prediction=prediction, accuracy = accu ))
